...
# Написать декоратор из п.1, но с параметром – путь к логам (параметризованный декоратор).
# Применить написанный логгер к приложению из любого предыдущего д/з

# Данная функция возвращает генератор. Если этот пример плохой, я закоментил еще одну функцию суммирования ниже, можно на ней проверить
import datetime
import hashlib
